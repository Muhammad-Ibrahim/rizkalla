...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__aside_section_shop_by_shop_by_component__ = __webpack_require__("./src/app/aside-section/shop-by/shop-by.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__aside_section_best_sellers_best_sellers_component__ = __webpack_require__("./src/app/aside-section/best-sellers/best-sellers.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__aside_section_custom_services_custom_services_component__ = __webpack_require__("./src/app/aside-section/custom-services/custom-services.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__article_section_products_products_component__ = __webpack_require__("./src/app/article-section/products/products.component.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__aside_section_shop_by_shop_by_component__["a" /* ShopByComponent */],
                __WEBPACK_IMPORTED_MODULE_14__aside_section_best_sellers_best_sellers_component__["a" /* BestSellersComponent */],
                __WEBPACK_IMPORTED_MODULE_15__aside_section_custom_services_custom_services_component__["a" /* CustomServicesComponent */],
                __WEBPACK_IMPORTED_MODULE_16__article_section_products_products_component__["a" /* ProductsComponent */],
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(data) {
        ...
        this.data.currentCart.subscribe(function (currentCart) {
            _this.cart = currentCart;
        });
    }
    ProductsComponent.prototype.ngOnInit = function () {
    };
    ProductsComponent.prototype.addToCart = function (productName) {
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.changeCurrentCart = function (cart) {
        this.cart.next(cart);
    };
...
module.exports = "<div class=\"large\" id=\"header\">\n  <div id=\"logo\">\n    <img src=\"../../assets/logo.png\" alt=\"Rizkalla\">\n  </div>\n  <div id=\"searchForm\">\n    <div id=\"form\">\n      <input #productName (keyup)=\"search(productName.value)\" (focusout)=\"focusout()\" (keyup.enter)=\"result = false\" placeholder=\"Enter keyword here...\" id=\"productNameInput\">\n      <button id=\"search\"><i class=\"fa fa-search\"></i></button>\n    </div>\n    <ul class=\"list-group\" id=\"list\" *ngIf=\"result\">\n      <li class=\"list-group-item\" *ngFor=\"let p of productsCase\" (click)=\"productName.value=p.name; result=false\">\n        {{p.name}}\n      </li>\n    </ul>\n  </div>\n  <div id=\"cta\">\n    <div id=\"wrapper\">\n      <div id=\"cart\">\n        <span (click)=\"openCart()\">{{inCart}}</span>\n        <i (click)=\"openCart()\" class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i>\n        <ul id=\"cartList\" class=\"list-group\" *ngIf=\"cartLoadded\">\n          <li class=\"list-group-item\" *ngFor=\"let c of cart; let i = index\">\n            {{c}}<i (click)=\"removeFromCart(i)\" class=\"fa fa-times\" aria-hidden=\"true\"></i>\n          </li>\n          <button class=\"btn btn-primary\" (click)=\"return;\">Go to Cart</button>\n        </ul>\n      </div>\n      <div id=\"profile\">\n        <i class=\"fa fa-user\" aria-hidden=\"true\"></i>\n        <div id=\"registration\">\n          <div id=\"row1\">\n            <a routerLink=\"\" (click)=\"return;\">Sign In</a>\n            <span>&nbsp;/&nbsp;</span>\n            <a routerLink=\"\" (click)=\"return;\"> Join Free</a>\n          </div>\n          <div id=\"row2\">\n            <a routerLink=\"\" (click)=\"return;\">Welcome Guest</a>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>"
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(data) {
        var _this = this;
        this.data = data;
        this.cartLoadded = false;
        this.result = false;
        this.productName = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["FormControl"]();
        this.stop = 1;
        this.data.currentSharedProducts.subscribe(function (currentSharedProducts) {
            _this.products = currentSharedProducts;
        });
        this.data.currentCart.subscribe(function (currentCart) {
            _this.cart = currentCart;
            _this.inCart = _this.cart.length;
        });
    }
    ...
    HeaderComponent.prototype.focusout = function () {
        var _this = this;
        setTimeout(function () { return _this.result = false; }, 100);
    };
    HeaderComponent.prototype.ngOnInit = function () {
    };
    HeaderComponent.prototype.removeFromCart = function (i) {
